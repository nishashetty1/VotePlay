    ...
    return (
      ...
      >
        ...
        <motion.div
          ...
          className='bg-background-card p-8 rounded-2xl shadow-2xl border border-secondary/10 backdrop-blur-sm max-w-md text-center space-y-4'
        >
          <motion.div 
            animate={{ 
              rotate: 360,
          ...
          >
            Please keep the volume high for a better experience
          </motion.p>
          <p className='text-text-secondary text-sm'>
            There are important audio cues throughout the simulation that
            provide a realistic voting experience
          </p>
        </motion.div>
      </motion.div>
    );

...
const Home = () => {
  ...
  return (
    ...
    />
      ...
      >
        <div
          className="absolute inset-0 bg-[url('/assets/background.webp')] opacity-10 bg-center bg-contain"
        />
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 flex flex-col items-center justify-center min-h-screen">
          ...
          >
            ...
            >
              <div className="relative w-full">
                ...
                >
                  ...
                  {isAuthenticated() ? "Continue Simulation" : "Start Simulation"}
                </Link>
              </div>
            </motion.div>
            ...
            <motion.div
              variants={itemVariants}
              className="mt-8 sm:mt-12 p-6 sm:p-8 bg-background-card rounded-2xl shadow-xl border border-secondary/10 backdrop-blur-sm"
            >
              <h2 className="text-xl sm:text-2xl font-sanskrit text-text-primary mb-4 sm:mb-6">
              ...
              <div className="mt-6 p-4 sm:p-5 bg-background-darker rounded-lg border border-gray-800/50">
                <p className="text-text-secondary text-sm sm:text-base font-body leading-relaxed">
                  <strong className="text-primary font-medium">Note:</strong> This simulator is designed to help
                  users understand the basic principles of voting using EVM and
                  VVPAT. It is for educational purposes only.
                </p>
              </div>
